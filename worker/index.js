...
export default {
  async fetch(request, env) {
    ...
    const payload={model:env.OPENAI_MODEL||'gpt-5-mini',instructions,input,max_output_tokens:1000,store:false};
    ...
    return json({reply:reply.slice(0,6000)||'暂时没有生成回答，请再试一次。',sources:sources.slice(0,8)});
  }
};
